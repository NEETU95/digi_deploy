...
def get_parent_text(source_text, en_core, bcd5r):
    ...
    if start_line is not None and mother_father_keyword == mother_father_keywords[0]:
        ...
        for llt in mother_llt:
            ...
            all_parent_history.append(parent_medical_history)
            print("Comments for parent history llt $$$$$:", history_comments)
    ...
    parent = {
        ...
        "parent_medical_history": all_parent_history,
        "parent_past_drug_history": all_parent_drug_information
    }
